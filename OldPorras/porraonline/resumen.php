<!--<body background="emblem_yllow_l.jpg">-->
<?
...
$ptosmaxprimeros = 8 * mysql_result($resultpercentprimeros,0,"resultpercent");
...
$ptosmaxcuartos = 8 * mysql_result($resultpercentcuartos,0,"resultpercent");
...
$ptosmaxsemis = 4 * mysql_result($resultpercentsemis,0,"resultpercent");
...
$ptosmaxfinal = 2 * mysql_result($resultpercentfinal,0,"resultpercent");
...
<th bgcolor='#dddddd'><font face="Arial, Helvetica, sans-serif" color=red>Ptos. Totales <br>(<? echo "$totpuntosmax"; ?> Ptos Jugados)</font></th>
</tr>
...
$tantoporcientopartidos=number_format((($puntospartidos*100)/$ptosmaxprimerafase), 2, '.', '');
...
$tantoporcientototal=number_format((($puntostotales*100)/$totpuntosmax), 2, '.', '');
?>
...
echo "<tr><td colspan=9 align=center>Habra premio para 1, 2 y 3 (60%, 30% y 10% respectivamente)</td></tr></table>";
