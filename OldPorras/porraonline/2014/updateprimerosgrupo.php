...
@mysql_select_db($database) or die( "Unable to select database");
	...
	while ($j < $numdos) {
		...
		echo "*$grupob*-*$grupob_usu*<br>";
		echo "*$grupod*-*$grupod_usu*<br>";
		echo "*$grupoh*-*$grupoh_usu*<br>";
		...
		$query_update_res="UPDATE resumen SET puntosprimeros='$puntos' WHERE usuario='$usuario'";
		echo "<br>USUARIO-RES: $usuario PUNTOSPRIMEROS $puntos -> $query_update_res"; 
		mysql_query($query_update_res);
		++$j;
	}
mysql_close();
