...
$game_status = $_POST['game_status'] ?? 'not_started';
$valid_statuses = ['not_started', 'group_stage', 'knockout', 'finished'];
...
$boot2_awarded = isset($_POST['golden_boot_2_awarded']) ? 1 : 0;
$boot3_awarded = isset($_POST['golden_boot_3_awarded']) ? 1 : 0;
$ball2_awarded = isset($_POST['golden_ball_2_awarded']) ? 1 : 0;
$ball3_awarded = isset($_POST['golden_ball_3_awarded']) ? 1 : 0;
...
$db->prepare(
    "UPDATE tournament_settings SET
        ...
        golden_boot_2_awarded = ?, golden_boot_3_awarded = ?,
        golden_ball_2_awarded = ?, golden_ball_3_awarded = ?
     WHERE id = 1"
)->execute([
